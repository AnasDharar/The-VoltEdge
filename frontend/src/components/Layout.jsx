...
const Layout = ({ children }) => {
  return (
    <div className="min-h-screen font-sora text-slate-900 relative w-full flex flex-col">
        ...
        <main className="relative mx-auto px-6 pb-20 z-10 flex-grow w-full max-w-7xl">
            {children}
        </main>
